                    ...
                    <div class="product-left-sidebar">
                        ...
                        <div class="product-single-sidebar">
                            ...
                            <ul>
                                ...
                                <li>
                                    <label class="cheker">
                                        <input {{ ($filter_price == '1-200000' ? 'checked' : '') }} class="filter-price" type="radio" name="price" value="1-200000"/>
                                        <span></span>
                                    </label>
                                    <a href="#">Dưới 2 trăm
                                    </a>
                                ...
                                <li>
                                    <label class="cheker">
                                        <input {{ ($filter_price == '200000-400000' ? 'checked' : '') }} class="filter-price" type="radio" name="price" value="200000-400000"/>
                                        <span></span>
                                    </label>
                                    <a href="#">Từ 2 - 4 trăm
                                    </a>
                                ...
                                <li>
                                    <label class="cheker">
                                        <input {{ ($filter_price == '400000-700000' ? 'checked' : '') }} class="filter-price" type="radio" name="price" value="400000-700000"/>
                                        <span></span>
                                    </label>
                                    <a href="#">Từ 4 - 7 trăm
                                    </a>
                                ...
                                <li>
                                    <label class="cheker">
                                        <input {{ ($filter_price == '700000-1300000' ? 'checked' : '') }} class="filter-price" type="radio" name="price" value="700000-1300000"/>
                                        <span></span>
                                    </label>
                                    <a href="#">Từ 7 - 1 triệu 3
                                    </a>
                                </li>
                                <li>
                                    <label class="cheker">
                                        <input {{ ($filter_price == '1300000-' ? 'checked' : '') }} class="filter-price" type="radio" name="price" value="1300000-"/>
                                        <span></span>
                                    </label>
                                    <a href="#">Trên 1 triệu 3 
                                    </a>
                                </li>
                            </ul>
                        </div>
